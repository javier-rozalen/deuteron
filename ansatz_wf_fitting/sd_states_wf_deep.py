...
two outputs, and uses multiple hidden layers with a variable number of hidden neurons. 
A 64-points tangential mesh is used as the momentum space upon which we train the ANN.
...
class NeuralNetwork(nn.Module):
    ...
    def forward(self, activation):
        ...
        return activation.squeeze()[0],activation.squeeze()[1]
...
################################ EPOCH LOOP ##################################
sep = "("
path = "../saved_models/s_d_states/nlayers2/Sigmoid/lr0.01/Hd{}_nlayers{}_epoch{}_seed{}_lr{}_actfun{}_optimizer{}_".format(Hd,nlayers,epochs,seed,learning_rate,
